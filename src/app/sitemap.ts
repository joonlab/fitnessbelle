...
export default function sitemap(): MetadataRoute.Sitemap {
  const baseUrl = 'https://fitnessbelle.vercel.app';

  return [
    { url: baseUrl, lastModified: new Date(), changeFrequency: 'weekly', priority: 1 },
    { url: `${baseUrl}/about`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.8 },
    { url: `${baseUrl}/locations/gurae`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.9 },
    { url: `${baseUrl}/locations/hwajeong`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.9 },
